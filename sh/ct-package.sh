...
cargo watch -s "clear && printf '\e[3J'; cargo test test_get_stmt_params --package sqlite3ffi -- --nocapture"
#cargo watch -s "clear && printf '\e[3J'; cargo test test_sigv --package sqlite3ffi -- --nocapture"